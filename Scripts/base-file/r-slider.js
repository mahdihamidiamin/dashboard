                ...
                obj.each(function () {
                    ...
                    switch (setting.slider_control) {
                        ...
                        case 'icon':
                            ...
                            break;
                        case 'icon-font':
                            $(idElement).append(' <a class="prev-slide has-icon-slider icon-font"> <i class="fas fa-arrow-right"></i></a>' +
                                ' <a  class="next-slide has-icon-slider icon-font" > <i class="fas fa-arrow-left"></i></a >');
                            break;
                        case 'none':
                            break;
                        default:
